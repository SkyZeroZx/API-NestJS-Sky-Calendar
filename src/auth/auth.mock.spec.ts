...
export class AuthMockService {
  ...
  public static readonly userReset: User = {
    ...
    updateAt: new Date(),
    nombre: 'RESET',
    apellidoPaterno: 'RESET',
    apellidoMaterno: 'RESET',
    estado: Constant.ESTADOS_USER.RESETEADO,
    firstLogin: false,
    hashPassword: function (): Promise<void> {
      return;
  ...
  public static readonly userCreate: User = {
    ...
    updateAt: new Date(),
    nombre: 'CREADO',
    apellidoPaterno: 'CREADO',
    apellidoMaterno: 'CREADO',
    estado: Constant.ESTADOS_USER.CREADO,
    firstLogin: false,
    hashPassword: function (): Promise<void> {
      return;
    },
  ...
  public static readonly userHabilitado: User = {
    ...
    updateAt: new Date(),
    nombre: 'HABILITADO',
    apellidoPaterno: 'HABILITADO',
    apellidoMaterno: 'HABILITADO',
    estado: Constant.ESTADOS_USER.HABILITADO,
    firstLogin: false,
    hashPassword: function (): Promise<void> {
      return;
    },
  ...
  public static readonly userBloq: User = {
    ...
    updateAt: new Date(),
    nombre: 'BLOQUEADO',
    apellidoPaterno: 'BLOQUEADO',
    apellidoMaterno: 'BLOQUEADO',
    estado: Constant.ESTADOS_USER.BLOQUEADO,
    firstLogin: false,
    hashPassword: function (): Promise<void> {
      return;
    },
